            ...
            <div class="app-sidebar">
                ...
                @if (auth()->user()->canAccess('customers'))
                    <a href="{{ route('customers.index') }}"
                        class="sb-item {{ request()->routeIs('customers.*') ? 'active' : '' }}" data-label="Customers">
                ...
                @if (auth()->user()->canAccess('rentals'))
                    <a href="{{ route('rentals.index') }}"
                        class="sb-item {{ request()->routeIs('rentals.*') ? 'active' : '' }}" data-label="Rentals">
                ...
                @if (auth()->user()->canAccess('sales'))
                    <a href="{{ route('sales.index') }}"
                        class="sb-item {{ request()->routeIs('sales.*') ? 'active' : '' }}" data-label="Sales">
                ...
                @if (auth()->user()->canAccess('products'))
                    <a href="{{ route('products.index') }}"
                        class="sb-item {{ request()->routeIs('products.*') ? 'active' : '' }}" data-label="Products">
                ...
                @if (auth()->user()->canAccess('vendors'))
                    <a href="{{ route('vendors.index') }}"
                        class="sb-item {{ request()->routeIs('vendors.*') ? 'active' : '' }}" data-label="Vendors">
                ...
                @if (auth()->user()->canAccess('employees'))
                    <a href="{{ route('employees.index') }}"
                        class="sb-item {{ request()->routeIs('employees.*') ? 'active' : '' }}" data-label="Employees">
                ...
                @if (auth()->user()->canAccess('salary'))
                    <a href="{{ route('salary.index') }}"
                        class="sb-item {{ request()->routeIs('salary.*') ? 'active' : '' }}" data-label="Salary">
                ...
                @if (auth()->user()->canAccess('advances'))
                    <a href="{{ route('advances.index') }}"
                        class="sb-item {{ request()->routeIs('advances.*') ? 'active' : '' }}" data-label="Advances">
