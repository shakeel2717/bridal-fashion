<div>
            ...
            <div class="table-card" style="padding:20px;">
                <div class="mb-4">
                    ...
                    <div class="walkin-toggle" style="max-width:300px;">
                        ...
                        <button type="button"
                                class="toggle-btn {{ $customerType === 'walkin' ? 'active' : '' }}"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        ...
                        @error('customerPhone1') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-6">
                        <label class="form-label">Phone 2</label>
                        <div class="d-flex gap-2">
                            <input type="text" wire:model="customerPhone2"
                    ...
                    <div class="col-6">
                        ...
                        <div class="d-flex gap-2">
                            <input type="text" wire:model="customerWhatsapp"
                                   class="form-control" placeholder="03XX-XXXXXXX">
                            <div class="gender-toggle">
                                <button type="button"
                    ...
                    <div class="col-6">
                        ...
                        @error('customerCnic') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    @endif
    ...
    <div class="row g-3">
        <div class="col-8">
            <div class="table-card" style="padding:20px;">
                <div style="font-size:11px; font-weight:700; text-transform:uppercase; color:var(--text-muted); margin-bottom:16px;">
                ...
                <div class="row g-3">
                    <div class="col-4">
                        ...
                        @error('bookingDate') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-4">
                        ...
                        @error('pickupDate') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-4">
                        <label class="form-label">
                    ...
                    <div class="col-8">
                        ...
                        <input type="text" wire:model="stitchingInstructions"
                               class="form-control"
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" wire:model="billRef"
                               class="form-control" placeholder="e.g. B-1042">
                    </div>
                    <div class="col-6">
        ...
        <div class="col-4">
            <div class="table-card" style="padding:20px;">
                ...
                <div style="font-size:12px; color:var(--text-muted); margin-bottom:2px;">
                    {{ $customerPhone1 }}
                    @if($customerPhone2) · {{ $customerPhone2 }} @endif
                </div>
                @if($customerCnic)
                ...
                <div style="margin-top:16px; background:#f0fff4; border:1px solid #9ae6b4; border-radius:8px; padding:12px;">
    ...
    <div class="row g-3">
        <div class="col-8">
            <div class="table-card" style="padding:20px;">
                ...
                {{-- Availability Notice --}}
                @if($pickupDate && $returnDate)
                <div style="background:#fffff0; border:1px solid #f6e05e; border-radius:8px; padding:10px 14px; margin-bottom:16px; font-size:12px; color:#b7791f;">
                    ...
                    Items marked <span style="color:#e53e3e; font-weight:700;">Booked</span> are already reserved.
                </div>
                @endif
                    ...
                    <div class="product-search-dropdown">
                        ...
                        <div class="search-item"
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                @else
                                    <div style="width:36px; height:36px; background:var(--gold-light); border-radius:6px; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                                        <i class="bi bi-image" style="font-size:14px; color:var(--gold);"></i>
                                    </div>
                                @endif
                                <div class="flex-fill">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            ...
                                            @if(!$result['available'])
                                                <span style="font-size:10px; background:#fff5f5; color:#c53030; padding:1px 6px; border-radius:3px; margin-left:4px; font-weight:700;">
                                                    Booked
                                                </span>
                                            @else
                                                <span style="font-size:10px; background:#f0fff4; color:#276749; padding:1px 6px; border-radius:3px; margin-left:4px; font-weight:700;">
                                                    Available
                                                </span>
                                            @endif
                                            ...
                                            <div class="search-item-category">
                                                {{ $result['category'] }}
                                                @if($result['size']) · Size: {{ $result['size'] }} @endif
                ...
                <div class="rental-item-row">
                    ...
                    <div class="row g-2 mb-2">
                        <div class="col-4">
                            <label style="font-size:10px; font-weight:600; color:var(--text-muted); text-transform:uppercase;">
                                Rental Price (Rs.)
                            </label>
                            <input type="number"
                                   wire:model.lazy="items.{{ $index }}.rental_price"
                                   wire:change="recalcTotal"
                        ...
                        <div class="col-8">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="e.g. needs alteration">
                        </div>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="d-flex gap-2 align-items-center mb-2">
                            <input type="text"
                                   ...
                                   class="form-control form-control-sm"
                                   placeholder="e.g. Name written on dupatta"
                                   style="flex:1;">
                            <input type="number"
                ...
                @endforeach
                @else
                <div style="text-align:center; padding:30px; color:var(--text-muted); font-size:13px; border:2px dashed var(--border); border-radius:8px;">
        ...
        <div class="col-4">
            <div class="rental-summary-box">
                <div style="font-size:11px; font-weight:700; text-transform:uppercase; color:rgba(255,255,255,0.5); margin-bottom:12px;">
                    Booking Summary
                </div>
                ...
                <div class="summary-row">
                    ...
                    <span class="s-value">{{ $pickupDate ? \Carbon\Carbon::parse($pickupDate)->format('d/m/Y') : '—' }}</span>
                </div>
                <div class="summary-row">
                    <span class="s-label">Return</span>
                    <span class="s-value">{{ $returnDate ? \Carbon\Carbon::parse($returnDate)->format('d/m/Y') : '—' }}</span>
                </div>
                <div class="summary-row">
                ...
                <div class="summary-row" style="font-size:11px;">
                    ...
                    <span class="s-value">
                        Rs. {{ number_format((float)$item['rental_price'] + collect($item['addons'])->sum(fn($a) => (float)($a['price'] ?? 0)), 0) }}
                    </span>
                </div>
                @endforeach
    ...
    <div class="row g-3">
            ...
            <div class="table-card" style="padding:20px;">
                ...
                <div class="row g-3">
                    <div class="col-4">
                        ...
                        <input type="number" wire:model.lazy="totalAmount"
                               wire:change="recalcTotal"
                               class="form-control"
                    ...
                    <div class="col-12">
                        <div style="background:#f7fafc; border:1px solid var(--border); border-radius:8px; padding:14px;">
                            <div style="font-size:11px; color:var(--text-muted); margin-bottom:4px;">Remaining Balance</div>
                            <div style="font-size:24px; font-weight:800; color:{{ (float)$advancePaid >= (float)$totalAmount ? '#38a169' : '#e53e3e' }};">
        ...
        <div class="col-4">
            ...
            <button class="btn btn-primary w-100"
                    style="height:46px; font-size:14px; font-weight:700;"
                    wire:click="save"
