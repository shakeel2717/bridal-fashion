            ...
            <div class="table-card mb-3" style="padding:20px;">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        ...
                        @error('customerPhone1') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-6">
            ...
            <div class="table-card mb-3" style="padding:20px;">
                ...
                <div style="position:relative; margin-bottom:16px;">
                    <input type="text"
                           ...
                           placeholder="Search product code or name to add...">
                    <i class="bi bi-search" style="position:absolute; right:12px; top:8px; color:var(--text-muted); font-size:13px;"></i>
                ...
                <div class="rental-item-row mb-3">
                    ...
                    <div style="background:#fff5f5; border-radius:6px; padding:10px 12px; margin-bottom:10px; font-size:12px; display:flex; align-items:center; justify-content:space-between;">
                ...
                @empty
                <div style="text-align:center; padding:20px; color:var(--text-muted); font-size:13px; border:2px dashed var(--border); border-radius:8px;">
        ...
        <div class="col-4">
            ...
            <div class="table-card mb-3" style="padding:16px;">
                ...
                <div style="background:#f7fafc; border-radius:8px; padding:12px; border:1px solid var(--border);">
                    ...
                    <div style="font-size:20px; font-weight:800; color:{{ (float)$remainingBalance > 0 ? '#e53e3e' : '#38a169' }};">
