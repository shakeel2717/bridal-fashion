                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    ...
                                    <button class="btn btn-sm {{ $category->is_active ? 'btn-outline-warning' : 'btn-outline-success' }} action-btn"
                                            wire:click="toggleStatus({{ $category->id }})"
                                            title="{{ $category->is_active ? 'Deactivate' : 'Activate' }}">
                                        <i class="bi bi-{{ $category->is_active ? 'pause' : 'play' }}" style="font-size:12px;"></i>
                                    </button>
