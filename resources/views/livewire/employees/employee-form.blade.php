                ...
                <div class="modal-body" style="padding:20px 24px;">
                    <div class="row g-3">
                        ...
                        <div class="col-4">
                            ...
                            <input type="number"
                                   wire:model="salaryAmount"
                                   class="form-control @error('salaryAmount') is-invalid @enderror"
                                   placeholder="0" min="0">
                            @error('salaryAmount') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        ...
                        <div class="col-4" style="padding-top:28px;">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox"
                                       wire:model="isActive" id="empActive">
...
<script>
    document.addEventListener('livewire:initialized', () => {
        ...
        Livewire.on('open-employee-modal', () => modal.show());
        Livewire.on('close-employee-modal', () => modal.hide());
    });
</script>
@endpush