                    ...
                    <div class="mb-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox"
                                   wire:model="isActive" id="vendorActive">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    ...
                                    <button class="btn btn-sm {{ $vendor->is_active ? 'btn-outline-warning' : 'btn-outline-success' }} action-btn"
                                            wire:click="toggleStatus({{ $vendor->id }})"
                                            title="{{ $vendor->is_active ? 'Deactivate' : 'Activate' }}">
                                        <i class="bi bi-{{ $vendor->is_active ? 'pause' : 'play' }}" style="font-size:12px;"></i>
                                    </button>
