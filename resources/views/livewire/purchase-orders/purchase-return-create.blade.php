<div>
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <div class="page-title">Purchase Return</div>
            <div class="page-subtitle">
                {{ $po->po_number }} · {{ $po->vendor->name }}
            </div>
        </div>
        <a href="{{ route('purchase-orders.show', $po->id) }}" class="btn btn-sm btn-outline-secondary">
            ...
            <div class="table-card mb-3" style="padding:20px;">
                ...
                @if (count($returnItems) === 0)
                    <div class="alert alert-warning py-2" style="font-size:13px;">
                        ...
                        No returnable items found. Items must be received before they can be returned.
                    </div>
                @else
                    <table class="table mb-0" style="font-size:12px;">
                        <thead>
                            <tr>
                                ...
                                <th>Item</th>
                                <th style="text-align:center; width:80px;">Max Qty</th>
        ...
        <div class="col-4">
            ...
            <div class="table-card mb-3" style="padding:0; overflow:hidden;">
                <div style="background:var(--navy); padding:12px 16px;">
                    <div style="font-size:14px; font-weight:700; color:#fff;">{{ $po->vendor->name }}</div>
                    <div style="font-size:11px; color:rgba(255,255,255,0.6);">{{ $po->po_number }}</div>
                </div>
            ...
            <button class="btn btn-danger w-100" style="height:44px; font-size:14px; font-weight:700;"
                ...
                <i class="bi bi-box-arrow-left me-2"></i> Submit Return
            </button>
        </div>
    </div>
</div>
