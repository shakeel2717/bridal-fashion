                ...
                <div class="row g-3">
                    <div class="col-6">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button type="button"
                                    wire:click="$set('showVendorForm', true)"
                                    class="btn btn-outline-secondary"
                                    style="padding:0 12px;" title="Add vendor">
                                <i class="bi bi-plus-lg"></i>
                            </button>
                        </div>
                        @error('vendorId') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                        @else
                        <div style="background:#f0fff4; border:1.5px solid #9ae6b4; border-radius:8px; padding:10px;">
                            <div class="row g-2">
                                <div class="col-7">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" wire:model="vendorBillNumber"
                               class="form-control" placeholder="e.g. VB-2024-001">
                    </div>
            ...
            <div class="table-card mb-3" style="padding:20px;">
                ...
                <div style="position:relative; margin-bottom:14px;">
                    <input type="text"
                           ...
                           class="form-control form-control-sm"
                           placeholder="Search existing product to add...">
                ...
                <div style="background:#f7fafc; border-radius:8px; padding:12px; margin-bottom:8px;">
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-2" style="text-align:right; font-size:13px; font-weight:700; color:var(--navy);">
            ...
            <div class="table-card" style="padding:20px;">
                ...
                <div class="row g-3">
                    <div class="col-4">
                        ...
                        <input type="number" wire:model.lazy="initialPayment"
                               class="form-control" min="0" placeholder="0">
                    </div>
                    <div class="col-4">
        ...
        <div class="col-4">
            ...
            <div class="d-flex flex-column gap-2">
                <button class="btn btn-primary w-100"
                        style="height:44px; font-size:14px; font-weight:700;"
                        wire:click="save('ordered')"
