                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <label class="form-label">
                                Product Group
                                <span style="font-size:10px; color:var(--text-muted); font-weight:400;">(link similar items)</span>
                            </label>
                            @if(!$showGroupForm)
                            <div class="d-flex gap-2">
                                ...
                                <button type="button" wire:click="openGroupForm"
                                        class="btn btn-outline-secondary" style="padding:0 12px;" title="New group">
                                    <i class="bi bi-plus-lg"></i>
                                </button>
                            </div>
                            @else
                            <div style="background:#ebf8ff; border:1.5px solid #bee3f8; border-radius:8px; padding:10px;">
                                <div class="row g-2">
                                    <div class="col-8">
                                        <input type="text" wire:model="newGroupName"
                                               class="form-control form-control-sm @error('newGroupName') is-invalid @enderror"
                                               placeholder="Group name *">
                                        @error('newGroupName') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                    <div class="col-4">
                                    ...
                                    <div class="col-12 d-flex gap-2">
                                        <button wire:click="saveGroup" class="btn btn-sm btn-primary flex-fill">Save</button>
                                        <button wire:click="cancelGroupForm" class="btn btn-sm btn-outline-secondary">Cancel</button>
                                    </div>
                                </div>
                            </div>
                            @endif
                        ...
                        <div class="col-4">
                            <label class="form-label">
                                ...
                                <span style="font-size:10px; color:var(--text-muted); font-weight:400;">
                                    @if($type === 'sale') (stock qty) @else (creates N separate items) @endif
                                </span>
                                @endif
                            </label>
                        ...
                        <div class="col-4" style="padding-top:28px;">
                            <div style="background:#fffff0; border:1px solid #f6e05e; border-radius:6px; padding:8px 10px; font-size:11px; color:#b7791f;">
                                <i class="bi bi-info-circle me-1"></i>
                                Stock starts at 0. Add a Purchase Order to receive stock.
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div style="background:#f7fafc; border:1px solid var(--border); border-radius:8px; padding:14px;">
                                ...
                                <div style="display:grid; grid-template-columns: 50px 1fr 1fr 1fr; gap:8px; margin-bottom:6px;">
                                    ...
                                    <div style="font-size:10px; font-weight:700; color:var(--text-muted);">CODE <span style="color:#e53e3e;">*</span></div>
                                    <div style="font-size:10px; font-weight:700; color:var(--text-muted);">COLOR</div>
                                    <div style="font-size:10px; font-weight:700; color:var(--text-muted);">SIZE</div>
                                </div>
                                @foreach($itemVariants as $i => $variant)
                                <div style="display:grid; grid-template-columns: 50px 1fr 1fr 1fr; gap:8px; margin-bottom:6px; align-items:start;">
                                    <div style="padding-top:6px;">
                                        <span class="tbl-code-badge" style="font-size:10px;">{{ $i + 1 }}</span>
                                    </div>
                                    <div>
                                        <input type="text"
                        ...
                        <div class="col-4">
                            ...
                            <input type="text" wire:model="itemVariants.0.code"
                                   ...
                                   placeholder="e.g. BL-001"
                                   style="text-transform:uppercase; font-family:monospace;">
                            @error('itemVariants.0.code') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-4">
                            <label class="form-label">Color</label>
                            <input type="text" wire:model="itemVariants.0.color"
                                   class="form-control" placeholder="e.g. Red, Golden">
                        </div>
                        <div class="col-4">
                            <label class="form-label">Size / Waist</label>
                            <input type="text" wire:model="itemVariants.0.size"
                                   class="form-control" placeholder="e.g. 36, Free">
                        </div>
                        @endif
                        ...
                        <div class="col-12">
                            <label class="form-label">
                                Product Photo
                                <span style="color:var(--text-muted); font-weight:400; font-size:11px;">(optional, max 3MB)</span>
                            </label>
                            @if($existingPhoto)
                        ...
                        <div class="col-6">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="prodActive" style="font-size:13px;">Active</label>
                            </div>
                        </div>
