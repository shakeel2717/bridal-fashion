                    ...
                    <div class="row g-3">
                        <div class="row g-3">
                                ...
                                @if (!$showCategoryForm)
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="button" wire:click="openCategoryForm"
                                            class="btn btn-outline-secondary" style="padding:0 12px;"
                                            title="Add category">
                                ...
                                <div class="col-12">
                                    <div
                                        ...
                                        <div
                                            ...
                                            Item Details
                                            <span style="font-weight:400; font-size:10px; margin-left:6px;">(code
                                                required
                                                for each item)</span>
                                        </div>
                                        <div
                            ...
                            @if (in_array($type, ['sale', 'both']))
                                <div class="col-4">
                                    <label class="form-label">Sale Price (Rs.) <span
                                            class="text-danger">*</span></label>
